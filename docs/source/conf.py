...
htmlhelp_basename = 'TemplateTestdoc'
...
latex_documents = [
    (master_doc, 'TemplateTest.tex', 'Template Test Documentation',
     'Robert Göhler', 'manual'),
]
...
man_pages = [
    (master_doc, 'templatetest', 'Template Test Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TemplateTest', 'Template Test Documentation',
     author, 'TemplateTest', 'One line description of project.',
     'Miscellaneous'),
]
